...
namespace mod
{
    ...
    void Mod::init()
    {
        ...
        /*hudConsole->addOption(page, "Item half milk",
        &chestRandomizer->itemThatReplacesHalfMilk, 0xFF); //for testing only
        hudConsole->addOption(page, "Item slingshot",
        &chestRandomizer->itemThatReplacesSlingShot, 0xFF); //for testing only
        hudConsole->addOption(page, "Normal Time:", &enableNormalTime, 0x1); //for
        testing only hudConsole->addOption(page, "Set Day:", &setDay, 0x1); //for
        testing only*/
        ...
        hudConsole->addWatch(page, "AreaNodes0:", &gameInfo.localAreaNodes.unk_0[0],
        'x', WatchInterpretation::_u8); hudConsole->addWatch(page, "AreaNodes1:",
        &gameInfo.localAreaNodes.unk_0[1], 'x', WatchInterpretation::_u8);
        hudConsole->addWatch(page, "AreaNodes2:", &gameInfo.localAreaNodes.unk_0[2],
        'x', WatchInterpretation::_u8); hudConsole->addWatch(page, "AreaNodes3:",
        &gameInfo.localAreaNodes.unk_0[3], 'x', WatchInterpretation::_u8);
        hudConsole->addWatch(page, "AreaNodes4:", &gameInfo.localAreaNodes.unk_0[4],
        'x', WatchInterpretation::_u8); hudConsole->addWatch(page, "AreaNodes5:",
        &gameInfo.localAreaNodes.unk_0[5], 'x', WatchInterpretation::_u8);
        hudConsole->addWatch(page, "AreaNodes6:", &gameInfo.localAreaNodes.unk_0[6],
        'x', WatchInterpretation::_u8); hudConsole->addWatch(page, "AreaNodes7:",
        &gameInfo.localAreaNodes.unk_0[7], 'x', WatchInterpretation::_u8);
        hudConsole->addWatch(page, "AreaNodes8:", &gameInfo.localAreaNodes.unk_0[8],
        'x', WatchInterpretation::_u8); hudConsole->addWatch(page, "AreaNodes9:",
        &gameInfo.localAreaNodes.unk_0[9], 'x', WatchInterpretation::_u8); page =
        hudConsole->addPage("Local Area 2"); hudConsole->addWatch(page,
        "AreaNodes10:", &gameInfo.localAreaNodes.unk_0[10], 'x',
        WatchInterpretation::_u8); hudConsole->addWatch(page, "AreaNodes11:",
        &gameInfo.localAreaNodes.unk_0[11], 'x', WatchInterpretation::_u8);
        hudConsole->addWatch(page, "AreaNodes12:", &gameInfo.localAreaNodes.unk_0[12],
        'x', WatchInterpretation::_u8); hudConsole->addWatch(page, "AreaNodes13:",
        &gameInfo.localAreaNodes.unk_0[13], 'x', WatchInterpretation::_u8);
        hudConsole->addWatch(page, "AreaNodes14:", &gameInfo.localAreaNodes.unk_0[14],
        'x', WatchInterpretation::_u8); hudConsole->addWatch(page, "AreaNodes15:",
        &gameInfo.localAreaNodes.unk_0[15], 'x', WatchInterpretation::_u8);
        hudConsole->addWatch(page, "AreaNodes16:", &gameInfo.localAreaNodes.unk_0[16],
        'x', WatchInterpretation::_u8); hudConsole->addWatch(page, "AreaNodes17:",
        &gameInfo.localAreaNodes.unk_0[17], 'x', WatchInterpretation::_u8);
        hudConsole->addWatch(page, "AreaNodes18:", &gameInfo.localAreaNodes.unk_0[18],
        'x', WatchInterpretation::_u8); hudConsole->addWatch(page, "AreaNodes19:",
        &gameInfo.localAreaNodes.unk_0[19], 'x', WatchInterpretation::_u8); page =
        hudConsole->addPage("Local Area 3"); hudConsole->addWatch(page,
        "AreaNodes20:", &gameInfo.localAreaNodes.unk_0[20], 'x',
        WatchInterpretation::_u8); hudConsole->addWatch(page, "AreaNodes21:",
        &gameInfo.localAreaNodes.unk_0[21], 'x', WatchInterpretation::_u8);
        hudConsole->addWatch(page, "AreaNodes22:", &gameInfo.localAreaNodes.unk_0[22],
        'x', WatchInterpretation::_u8); hudConsole->addWatch(page, "AreaNodes23:",
        &gameInfo.localAreaNodes.unk_0[23], 'x', WatchInterpretation::_u8);
        hudConsole->addWatch(page, "AreaNodes24:", &gameInfo.localAreaNodes.unk_0[24],
        'x', WatchInterpretation::_u8); hudConsole->addWatch(page, "AreaNodes25:",
        &gameInfo.localAreaNodes.unk_0[25], 'x', WatchInterpretation::_u8);
        hudConsole->addWatch(page, "AreaNodes26:", &gameInfo.localAreaNodes.unk_0[26],
        'x', WatchInterpretation::_u8); hudConsole->addWatch(page, "AreaNodes27:",
        &gameInfo.localAreaNodes.unk_0[27], 'x', WatchInterpretation::_u8);
        hudConsole->addWatch(page, "NbKeys:", &gameInfo.localAreaNodes.nbKeys, 'x',
        WatchInterpretation::_u8); hudConsole->addWatch(page, "Dungeon flags:",
        &gameInfo.localAreaNodes.dungeon, 'x', WatchInterpretation::_u8); page =
        hudConsole->addPage("Local Area 4"); hudConsole->addWatch(page,
        "AreaNodes30:", &gameInfo.localAreaNodes.unk_1E[0], 'x',
        WatchInterpretation::_u8); hudConsole->addWatch(page, "AreaNodes31:",
        &gameInfo.localAreaNodes.unk_1E[1], 'x', WatchInterpretation::_u8);*/

        // item slots
        /*page = hudConsole->addPage("Item slots 1");
        hudConsole->addWatch(page, "Boomerang:",
        &gameInfo.scratchPad.itemWeel.Boomerang, 'x', WatchInterpretation::_u8);
        hudConsole->addWatch(page, "Slot 1:", &gameInfo.scratchPad.itemSlots[0x1],
        'x', WatchInterpretation::_u8);

        hudConsole->addWatch(page, "flags1:",
        &gameInfo.scratchPad.itemFlags.itemFlags1, 'x', WatchInterpretation::_u64);
        hudConsole->addWatch(page, "flags2:",
        &gameInfo.scratchPad.itemFlags.itemFlags2, 'x', WatchInterpretation::_u64);
        hudConsole->addWatch(page, "flags3:",
        &gameInfo.scratchPad.itemFlags.itemFlags3, 'x', WatchInterpretation::_u64);
        hudConsole->addWatch(page, "falgs4:",
        &gameInfo.scratchPad.itemFlags.itemFlags4, 'x', WatchInterpretation::_u64);*/

        /*page = hudConsole->addPage("Warps 1");
        hudConsole->addOption(page, "Mirror Chamber:",
        &gameInfo.scratchPad.allAreaNodes.Gerudo_Desert.unk_0[0xE], 0xFF);
        hudConsole->addOption(page, "Gerudo Mesa:",
        &gameInfo.scratchPad.allAreaNodes.Gerudo_Desert.unk_0[0x9], 0xFF);
        hudConsole->addOption(page, "Snowpeak Top:",
        &gameInfo.scratchPad.allAreaNodes.Snowpeak.unk_0[0x9], 0xFF);
        hudConsole->addOption(page, "Sacred Grove:",
        &gameInfo.scratchPad.allAreaNodes.Sacred_Grove.unk_0[0x17], 0xFF);
        hudConsole->addOption(page, "Eldin Bridge:",
        &gameInfo.scratchPad.allAreaNodes.Hyrule_Field.unk_0[0x17], 0xFF);
        hudConsole->addOption(page, "Castle Town:",
        &gameInfo.scratchPad.allAreaNodes.Hyrule_Field.unk_0[0xB], 0xFF);
        hudConsole->addOption(page, "Kakariko Gorge:",
        &gameInfo.scratchPad.allAreaNodes.Hyrule_Field.unk_0[0x9], 0xFF);
        hudConsole->addOption(page, "Zoras Domain:",
        &gameInfo.scratchPad.allAreaNodes.Lanyru.unk_0[0xB], 0xFF);
        hudConsole->addOption(page, "Lake Hylia:",
        &gameInfo.scratchPad.allAreaNodes.Lanyru.unk_0[0xA], 0xFF);
        hudConsole->addOption(page, "Zora River:",
        &gameInfo.scratchPad.allAreaNodes.Lanyru.unk_0[0x9], 0xFF);

        hudConsole->addWatch(page, "Mirror Chamber:",
        &gameInfo.scratchPad.allAreaNodes.Gerudo_Desert.unk_0[0xE], 'x',
        WatchInterpretation::_u8);//1 hudConsole->addWatch(page, "Gerudo Mesa:",
        &gameInfo.scratchPad.allAreaNodes.Gerudo_Desert.unk_0[0x9], 'x',
        WatchInterpretation::_u8);//32 hudConsole->addWatch(page, "Snowpeak Top:",
        &gameInfo.scratchPad.allAreaNodes.Snowpeak.unk_0[0x9], 'x',
        WatchInterpretation::_u8);//32 hudConsole->addWatch(page, "Sacred Grove:",
        &gameInfo.scratchPad.allAreaNodes.Sacred_Grove.unk_0[0x17], 'x',
        WatchInterpretation::_u8);//16 hudConsole->addWatch(page, "Eldin Bridge:",
        &gameInfo.scratchPad.allAreaNodes.Hyrule_Field.unk_0[0x17], 'x',
        WatchInterpretation::_u8);//8 hudConsole->addWatch(page, "Castle Town:",
        &gameInfo.scratchPad.allAreaNodes.Hyrule_Field.unk_0[0xB], 'x',
        WatchInterpretation::_u8);//8 hudConsole->addWatch(page, "Kakariko Gorge:",
        &gameInfo.scratchPad.allAreaNodes.Hyrule_Field.unk_0[0x9], 'x',
        WatchInterpretation::_u8);//32 hudConsole->addWatch(page, "Zoras Domain:",
        &gameInfo.scratchPad.allAreaNodes.Lanyru.unk_0[0xB], 'x',
        WatchInterpretation::_u8);//4 hudConsole->addWatch(page, "Lake Hylia:",
        &gameInfo.scratchPad.allAreaNodes.Lanyru.unk_0[0xA], 'x',
        WatchInterpretation::_u8);//4 hudConsole->addWatch(page, "Zora River:",
        &gameInfo.scratchPad.allAreaNodes.Lanyru.unk_0[0x9], 'x',
        WatchInterpretation::_u8);//32 page = hudConsole->addPage("Warps 2");
        hudConsole->addOption(page, "Death Mountain:",
        &gameInfo.scratchPad.allAreaNodes.Eldin.unk_0[0x9], 0xFF);
        hudConsole->addOption(page, "Kakariko:",
        &gameInfo.scratchPad.allAreaNodes.Eldin.unk_0[0x8], 0xFF);
        hudConsole->addOption(page, "South Faron:",
        &gameInfo.scratchPad.allAreaNodes.Faron.unk_0[0x13], 0xFF);
        hudConsole->addOption(page, "North Faron:",
        &gameInfo.scratchPad.allAreaNodes.Faron.unk_0[0xB], 0xFF);
        hudConsole->addOption(page, "Ordon Spring:",
        &gameInfo.scratchPad.allAreaNodes.Ordon.unk_0[0xD], 0xFF);

        hudConsole->addWatch(page, "Death Mountain:",
        &gameInfo.scratchPad.allAreaNodes.Eldin.unk_0[0x9], 'x',
        WatchInterpretation::_u8);//32 hudConsole->addWatch(page, "Kakariko:",
        &gameInfo.scratchPad.allAreaNodes.Eldin.unk_0[0x8], 'x',
        WatchInterpretation::_u8);//128 hudConsole->addWatch(page, "South Faron:",
        &gameInfo.scratchPad.allAreaNodes.Faron.unk_0[0x13], 'x',
        WatchInterpretation::_u8);//128 hudConsole->addWatch(page, "North Faron:",
        &gameInfo.scratchPad.allAreaNodes.Faron.unk_0[0xB], 'x',
        WatchInterpretation::_u8);//4 hudConsole->addWatch(page, "Ordon Spring:",
        &gameInfo.scratchPad.allAreaNodes.Ordon.unk_0[0xD], 'x',
        WatchInterpretation::_u8);//16*/
        ...
        hudConsole->addOption(page, "trigger:", &trigerLoadSave, 0x1); //for testing
        only*/
        ...
        // Fix BiTE
        eventListener->addLoadEvent(stage::allStages[Stage_Faron_Woods], 0x0, 0x17, 0xFF, 0xFF, game_patch::giveEpona,
                                    event::LoadEventAccuracy::Stage_Room_Spawn);
        ...
        eventListener->addLoadEvent(stage::allStages[Stage_Castle_Town_Interiors], 0x6, 0xC, 0xFF, 0xFF, game_patch::skipMDH,
                                    event::LoadEventAccuracy::Stage_Room_Spawn);

        // Allow Faron Escape
        eventListener->addLoadEvent(stage::allStages[Stage_Faron_Woods], 0xFF, 0xFF, 0x0, 0xFF, game_patch::allowFaronEscape,
                                    event::LoadEventAccuracy::Stage_Room_Spawn);
        ...
        eventListener->addLoadEvent(stage::allStages[Stage_Snowpeak_Ruins], 0xFF, 0xFF, 0xFF, 0xFF,
                                    game_patch::openSnowpeakDoors, event::LoadEventAccuracy::Stage_Room_Spawn);

        // unlock HF gates
        eventListener->addLoadEvent(stage::allStages[Stage_Hyrule_Field], 0xFF, 0xFF, 0xFF, 0xFF, game_patch::unlockHFGates,
        ...
        // skip MS Puzzle
        eventListener->addLoadEvent(stage::allStages[Stage_Sacred_Grove], 0xFF, 0xFF, 0xFF, 0xFF, game_patch::skipGrovePuzzle,
                                    event::LoadEventAccuracy::Stage);

        // skip Cart Escort
        eventListener->addLoadEvent(stage::allStages[Stage_Hyrule_Field], 0xC, 0x2, 0xFF, 0xFF, game_patch::skipCartEscort,
                                    event::LoadEventAccuracy::Stage_Room_Spawn);
        ...
        eventListener->addLoadEvent(stage::allStages[Stage_Faron_Woods], 0xFF, 0xFF, 0x0, 0xFF, game_patch::fixLanayruFaron,
                                    event::LoadEventAccuracy::Stage_Room_Spawn);
    ...
    void Mod::procNewFrame()
    {
        ...
        {  // remove the item get animations for floor pickups (except silver
           // rupee)
        ...
        if (tp::d_a_alink::checkStageName(stage::allStages[Stage_Faron_Woods]))
        {
            if (0xB == gameInfo.eventSystem.currentEventID)
            {
                ...
                {
                    gameInfo.scratchPad.itemFlags.itemFlags3.Vessel_Of_Light_Faron =
                        0b1;  // set flag for vessel since we'll skip it by reloading
        ...
        /*if (gameInfo.scratchPad.unk_0[0x019] == 0)
        {
                ...
                strncpy(tp::d_com_inf_game::wallet_text, walletText,
        sizeof(tp::d_com_inf_game::wallet_text) - 1);

                const char* walletDescription = "A wallet from your childhood. It
        holds up to 1,000 Rupees."; strncpy(tp::d_com_inf_game::wallet_description,
        walletDescription, sizeof(tp::d_com_inf_game::wallet_description) - 1);
        }
        ...
        sizeof(tp::d_com_inf_game::wallet_text) - 1);
                ...
                const char* walletDescription = "A wallet given to you by Agitha,
        princess of the insect kingdom. It can hold 5,000 Rupees.";
        ...
        sizeof(tp::d_com_inf_game::wallet_text) - 1);
                ...
                const char* walletDescription = "The wallet given by Agitha to
        benefactors of the insect kingdom. It can hold up to 9,999 Rupees.";
                strncpy(tp::d_com_inf_game::wallet_description, walletDescription,
        sizeof(tp::d_com_inf_game::wallet_description) - 1);
        }*/
    ...
    s32 Mod::procItemCreateFunc(const float pos[3], s32 item, const char funcIdentifier[32])
    {
        ...
        // Runs once when Link picks up an item with text and is holding it towards
        // the camera
    ...
    bool Mod::proc_query022(void* unk1, void* unk2, s32 unk3)
    {
        ...
        if (tp::d_a_alink::checkStageName(stage::allStages[Stage_Ordon_Interiors]))
        {
            ...
            {
                // Return false so that the door in Bo's house can be opened without
                // having the Iron Boots
                return false;
            }
        }
    ...
    bool Mod::procDoLink(tp::dynamic_link::DynamicModuleControl* dmc)
    {
        ...
        // Make sure a REL file is actually loaded, as do_link will clear the pointer
