...
/* 69 */{0x26, 2, stage::allStages[0], 6, 0x7, 0x6, 0b101000001010001000000, -16549.8789060, -1345.7093510, 2820.3918460, nullptr, nullptr}, //LBT Big Key Chest
...
/* 72 */{0x21, 3, stage::allStages[36], 1, 0x11, 0xFF, 0b100000100000000000010, -211.8681490, -61.3470460, -2693.1110840, nullptr, nullptr}, // Grotto - Deku Baba Heart Piece Chest
/* 73 */{0x06, 7, stage::allStages[35], 0, 0x7, 0xFF, 0b100000000010000000010, 28.7614960, 2.9684250, -455.4558110, nullptr, nullptr}, //Grotto - Helmasaur Chest
...
/* 89 */{0x06, 7, stage::allStages[39], 4, 0x7, 0xFF, 0b000000000000000000010, -312.1882930, -27.1700000, -1501.0155030, nullptr, nullptr}, //Grotto - Water Toadpoli Chest
...
/* 102 */{0x06, 7, stage::allStages[39], 4, 0x7, 0xFF, 0b101000000000000000010, -371.4389950, -27.1700000, -1627.2565920, nullptr, nullptr}, //Grotto - Shell Blade Chest
...
/* 105 */{0x05, 7, stage::allStages[38], 3, 0x7, 0xFF, 0b110000000000000000010, -1125.7841800, -133.9226530, -3012.3530270, nullptr, nullptr}, //Grotto - Skulltula Chest
...
/* 108 */{0x06, 7, stage::allStages[38], 3, 0x7, 0xFF, 0b110000000010000000010, -1061.2969970, -132.2552490, -3053.6071780, nullptr, nullptr}, //Grotto - Bubble Chest
...
/* 111 */{0x04, 7, stage::allStages[36], 1, 0x7, 0xFF, 0b000000000000000000010, 578.9967040, -266.3237300, -2138.4619140, nullptr, nullptr}, //Grotto - Chu, Baba, and Keese Right Chest
/* 112 */{0x03, 7, stage::allStages[36], 1, 0x7, 0xFF, 0b000000000000000000010, -281.6463620, -300.0000000, 910.2941280, nullptr, nullptr}, //Grotto - Chu, Baba, and Keese Rear Chest
/* 113 */{0x04, 7, stage::allStages[36], 1, 0x7, 0xFF, 0b000000000000000000010, -754.0296020, -256.7704770, -3001.7814940, nullptr, nullptr}, //Grotto - Chu, Babe, and Keese Left Chest
...
/* 119 */{0x06, 7, stage::allStages[57], 16, 0x7, 0xFF, 0b100000000010000000010, -53600.0000000, -3592.9699710, 23830.0000000, nullptr, nullptr}, //Castle Pillar Chest
/* 120 */{0x06, 7, stage::allStages[39], 4, 0x7, 0xFF, 0b000000000000000000010, -240.3374330, -27.1700000, -1660.1081540, nullptr, nullptr}, //Grotto - Tetike Chest
/* 121 */{0x05, 7, stage::allStages[35], 0, 0x7, 0xFF, 0b110000000000000000010, -1037.5682370, 1.0515240, -536.6557620, nullptr, nullptr}, //Grotto - Bombling Left Chest
/* 122 */{0x05, 7, stage::allStages[35], 0, 0x7, 0xFF, 0b110000000000000000010, -193.2892910, 150.0000000, -1135.5745850, nullptr, nullptr}, //Grotto - Bombling Right Chest
/* 123 */{0x05, 7, stage::allStages[39], 4, 0x7, 0xFF, 0b000000000000000000010, -251.5004430, -27.1700000, -1691.9121090, nullptr, nullptr}, //Grotto - Water Bomb Fish Chest
/* 124 */{0x06, 7, stage::allStages[38], 3, 0x8, 0xFF, 0b000000000000000000010, -1066.0302730, -132.1377870, -3046.8808590, nullptr, nullptr}, //Grotto - Desert Skulltula Chest
/* 125 */{0x04, 7, stage::allStages[59], 0, 0x8, 0xFF, 0b000000000010000000000, 51585.6210940, 1536.1500240, 58741.2500000, nullptr, nullptr}, //Desert Peahat Chest
/* 126 */{0x04, 7, stage::allStages[59], 0, 0x8, 0xFF, 0b000000000000000000000, 51813.6796880, 171.0510250, 46656.2773440, nullptr, nullptr}, //East Canyon Chest
/* 127 */{0x0E, 5, stage::allStages[59], 0, 0x8, 0xFF, 0b000000000000000000000, 30472.5644530, 778.0640260, 50140.5703120, nullptr, nullptr}, //Desert Lone Small Chest
...
/* 131 */{0x05, 7, stage::allStages[59], 0, 0x8, 0xFF, 0b000000000010000000000, -6940.8110350, 441.2112430, 48305.4023440, nullptr, nullptr}, //West Canyon Chest
/* 132 */{0x06, 7, stage::allStages[37], 2, 0x8, 0xFF, 0b110000100010000000010, -128.8401180, 150.0000000, -1330.3356930, nullptr, nullptr}, //Grotto - Poe and Boulder Chest
/* 133 */{0x04, 7, stage::allStages[59], 0, 0x8, 0xFF, 0b000000000000000000000, 9889.4482420, -732.8599850, 17813.8398440, nullptr, nullptr}, //Desert North Small Chest Behind Gate
/* 134 */{0x06, 7, stage::allStages[59], 0, 0x8, 0xFF, 0b000000000000000000000, 32741.2617190, 158.3099980, 68606.5468750, nullptr, nullptr}, //Desert South Chest Behind Gate
/* 135 */{0x04, 7, stage::allStages[59], 0, 0x8, 0xFF, 0b000000000000000000000, 3104.9711910, -732.8599850, 24575.0351560, nullptr, nullptr}, //Desert Top Left Chest By Fire 
/* 136 */{0x05, 7, stage::allStages[59], 0, 0x8, 0xFF, 0b000000000000000000000, 4945.0000000, -732.8599850, 25572.0000000, nullptr, nullptr}, //Desert Right Chest Under Scaffolding
/* 137 */{0x0E, 5, stage::allStages[59], 0, 0x8, 0xFF, 0b000000000000000000000, 1845.0000000, -732.8599850, 26130.0000000, nullptr, nullptr}, //Desert Bottom Left Chest Under Scaffolding
/* 138 */{0x04, 7, stage::allStages[59], 0, 0x8, 0xFF, 0b000000000000000000000, -6532.4062500, -732.8599850, 20852.4121090, nullptr, nullptr}, //Desert Lone Northwest Chest
/* 139 */{0x0E, 5, stage::allStages[59], 0, 0x8, 0xFF, 0b000000000000000000000, 4681.0947270, -162.9400020, 12575.7626950, nullptr, nullptr}, //Desert Boxes Chest
/* 140 */{0x0F, 5, stage::allStages[55], 1, 0x8, 0xFF, 0b000000000000000000000, 4761.6406250, 0.0000000, 1580.5701900, nullptr, nullptr}, //Bublin Camp Outside Watchtower Small Chest
/* 141 */{0x05, 7, stage::allStages[55], 1, 0x8, 0xFF, 0b000000000000000000000, 2389.0454100, 260.0000000, -1473.3872070, nullptr, nullptr}, //Bublin Camp Inner Tent Small Chest
/* 142 */{0x05, 7, stage::allStages[55], 3, 0x8, 0xFF, 0b010000000000000000000, 3633.6201170, 840.0000000, -12457.7001950, nullptr, nullptr}, //Outside Arbiter's Grounds Lanturn Chest
/* 143 */{0x20, 8, stage::allStages[24], 0, 0x8, 0xFF, 0b000000000000000000000, -3000.0000000, -19.0000000, 5600.0000000, nullptr, nullptr}, //AG Entrance Chest
/* 144 */{0x20, 8, stage::allStages[24], 15, 0x8, 0xFF, 0b000000000000000000000, 4125.0000000, -741.5800170, -2250.0000000, nullptr, nullptr}, //AG East Redead Lower Small Chest
/* 145 */{0x21, 3, stage::allStages[24], 2, 0x8, 0xFF, 0b000000000000000000000, 1300.0000000, 62.5000000, -3012.5000000, nullptr, nullptr}, //AG Lobby Heart Piece Chest
/* 146 */{0x23, 2, stage::allStages[24], 2, 0x8, 0x8, 0b000000000000000000000, -1300.0000000, 50.0000000, -3012.5000000, nullptr, nullptr}, //AG Map Chest
/* 147 */{0x24, 2, stage::allStages[24], 4, 0x8, 0x8, 0b000000000000000100000, 9400.0000000, 990.0599980, 6100.0000000, nullptr, nullptr}, //AG Compass Chest
/* 148 */{0x20, 8, stage::allStages[24], 4, 0x8, 0xFF, 0b000000000000000100000, 12275.0000000, 980.0000000, 4537.5000000, nullptr, nullptr}, //AG East Upper Turnable Redead Chest
/* 149 */{0x20, 8, stage::allStages[24], 14, 0x8, 0xFF, 0b000000000000000100000, 4150.0000000, 825.0000000, 775.0000000, nullptr, nullptr}, //AG Ghoul Rat Chest
/* 150 */{0x04, 7, stage::allStages[24], 6, 0x8, 0xFF, 0b000000000000000000000, -4065.0000000, 150.0000000, -2660.0000000, nullptr, nullptr}, //AG West Small Chest Behind Block
/* 151 */{0x04, 7, stage::allStages[24], 6, 0x8, 0xFF, 0b000000000000000000000, -4450.0000000, 400.0000000, 1150.0000000, nullptr, nullptr},  //AG West Chandelier Chest
/* 152 */{0x0A, 5, stage::allStages[24], 7, 0x8, 0xFF, 0b000000100100000000000, -9975.0000000, 500.0000000, -600.0000000, nullptr, nullptr}, //AG Stalfos West Small Chest
/* 153 */{0x0A, 5, stage::allStages[24], 7, 0x8, 0xFF, 0b000000100100000000000, -8113.0000000, 500.0000000, -1382.0000000, nullptr, nullptr}, //AG Stalfos Northeast Small Chest
/* 154 */{0x20, 8, stage::allStages[24], 16, 0x8, 0xFF, 0b000000000000000000000, 3970.0000000, -1050.0000000, -6080.0000000, nullptr, nullptr}, //AG North Turning Room Chest
/* 155 */{0x41, 0, stage::allStages[26], 51, 0x8, 0x8, 0b000100000010000000000, 0.0000000, 50.0000000, -6200.0000000, nullptr, nullptr}, //AG Spinner Chest
/* 156 */{0x0B, 5, stage::allStages[24], 13, 0x9, 0xFF, 0b000000000000100000000, -8331.4091800, -1800.0000000, -3677.7468260, nullptr, nullptr}, //AG Spinner Room First Small Chest
/* 157 */{0x04, 7, stage::allStages[24], 13, 0x9, 0xFF, 0b000000000000100000000, -10212.5000000, -1840.0000000, -3725.0000000, nullptr, nullptr}, //AG Spinner Room Second Small Chest
/* 158 */{0x03, 7, stage::allStages[24], 13, 0x9, 0xFF, 0b000000000000100000000, -10812.5000000, -1825.0000000, -5712.5000000, nullptr, nullptr}, //AG Spinner Room Lower Central Chest
/* 159 */{0x21, 3, stage::allStages[24], 13, 0x9, 0xFF, 0b000000000000100000000, -5475.0000000, -1325.0000000, -4875.0000000, nullptr, nullptr}, //AG Spinner Room Heart Piece Chest
/* 160 */{0x03, 7, stage::allStages[24], 13, 0x9, 0xFF, 0b000000000000100000000, -6225.0000000, -1125.0000000, -7275.0000000, nullptr, nullptr}, //AG Spinner Room Lower North Chest
/* 161 */{0x26, 2, stage::allStages[24], 9, 0x9, 0x9, 0b000000000000100000000, -3675.0000000, 500.0000000, -7250.0000000, nullptr, nullptr}, //AG Big Key Chest
/* 162 */{0x21, 3, stage::allStages[56], 11, 0x9, 0xFF, 0b000000000000100000000, -88260.0000000, 2950.0000000, -8150.0000000, nullptr, nullptr}, //Spinner Wall Heart Piece Chest
/* 163 */{0x0A, 5, stage::allStages[36], 1, 0x9, 0xFF, 0b100000000000100000010, 464.9176030, -262.3106380, -709.6952510, nullptr, nullptr}, //Grotto - Stalfos Right Small Chest
/* 164 */{0x0A, 5, stage::allStages[36], 1, 0x9, 0xFF, 0b100000000000100000010, -1153.7760010, -255.8396450, -980.6660160, nullptr, nullptr}, //Grotto - Stalfos Left Small Chest
/* 165 */{0x21, 3, stage::allStages[36], 1, 0x9, 0xFF, 0b100000100000100000010, -211.8499450, -60.9387400, -2691.0991210, nullptr, nullptr}, //Grotto - Stalfos Heart Piece Chest
/* 166 */{0x06, 7, stage::allStages[57], 16, 0x9, 0xFF, 0b100000000010100000000, -51500.0000000, -5180.0000000, 25970.0000000, nullptr, nullptr}, //Fountain Chest
/* 167 */{0x05, 7, stage::allStages[35], 0, 0x7, 0xFF, 0b110000000000000000010, -277.2709660, 150.0000000, -1096.2886960, nullptr, nullptr}, //Grotto - Rat and Chu Chu Chest
...
/* 171 */{0x20, 8, stage::allStages[27], 4, 0x10, 0xFF, 0b000000000000000000000, -1500.0000000, -60.0000000, -4458.0000000, nullptr, nullptr}, //SPR Courtyard Partially buried Chest
/* 172 */{0x04, 7, stage::allStages[27], 4, 0x10, 0xFF, 0b000000000000000000000, 1350.0000000, 50.0000000, -1400.0000000, nullptr, nullptr}, //SPR Courtyard Open Chest
/* 173 */{0xF4, 8, stage::allStages[27], 5, 0x10, 0x10, 0b000000000000000100000, 5300.0000000, 0.0000000, -5100.0000000, nullptr, nullptr}, //SPR Pumpkin Chest
/* 174 */{0x20, 8, stage::allStages[27], 4, 0x10, 0xFF, 0b000000000000000000000, 1350.0000000, -40.0000000, -4150.0000000, nullptr, nullptr}, //SPR Courtyard Buried Chest
/* 175 */{0x04, 7, stage::allStages[27], 8, 0x10, 0xFF, 0b000000100100000000000, -4355.0000000, 0.0000000, -2160.0000000, nullptr, nullptr}, //SPR Wooden Beam Room Small Chest
/* 176 */{0x24, 2, stage::allStages[27], 8, 0x10, 0x10, 0b000000100100000000000, -3510.0000000, 0.0000000, -1350.0000000, nullptr, nullptr}, //SPR Compass Chest
/* 177 */{0x0A, 5, stage::allStages[27], 4, 0x10, 0xFF, 0b000000100100000000000, 0.0000000, 0.0000000, -1250.0000000, nullptr, nullptr}, //SPR Courtyard South Ice Wall Small Chest
/* 178 */{0xF5, 8, stage::allStages[29], 51, 0x11, 0x11, 0b000000000100000000000, 0.0000000, 0.0000000, -3196.0000000, nullptr, nullptr}, //SPR Goat Cheese
/* 179 */{0x21, 3, stage::allStages[27], 7, 0x11, 0xFF, 0b000000000100000000000, -3600.0000000, 0.0000000, 1600.0000000, nullptr, nullptr}, //SPR West Breakable Floor Heart Piece Chest
/* 180 */{0x20, 8, stage::allStages[27], 8, 0x11, 0xFF, 0b000000000100000000000, -4350.0000000, 950.0000000, -3850.0000000, nullptr, nullptr}, //SPR Wooden Beam Room Chandelier Chest
/* 181 */{0x21, 3, stage::allStages[27], 0, 0x11, 0xFF, 0b000000000100000000000, 0.0000000, 1118.3201900, 4690.0000000, nullptr, nullptr}, //SPR Entrance Chandelier Heart Piece Chest
/* 182 */{0x04, 7, stage::allStages[27], 0, 0x11, 0xFF, 0b000000000100000000000, -900.0000000, -50.0000000, 5950.0000000, nullptr, nullptr}, //SPR Entrance Left Armor Small Chest
/* 183 */{0x03, 7, stage::allStages[27], 0, 0x11, 0xFF, 0b000000000100000000000, 930.0000000, -50.0000000, 5350.0000000, nullptr, nullptr}, //SPR Entrance Right Armor Small Chest
/* 184 */{0x20, 8, stage::allStages[27], 5, 0x11, 0xFF, 0b100000000110000000000, 4350.0000000, 953.0000000, -4900.0000000, nullptr, nullptr}, //SPR East Chilfos Chandelier Chest
/* 185 */{0x04, 7, stage::allStages[27], 9, 0x11, 0xFF, 0b000000000100000000000, -5347.3071290, -50.0000000, -6500.8867190, nullptr, nullptr}, //SPR West Cannon Storage Left Small Chest
/* 186 */{0x0A, 5, stage::allStages[27], 9, 0x11, 0xFF, 0b000000100100000000000, -1818.3217770, 0.0000000, -7562.9838870, nullptr, nullptr}, //SPR West Cannon Storage Right Small Chest
/* 187 */{0xF6, 2, stage::allStages[27], 11, 0x11, 0x11, 0b100000100100000000000, -4350.0000000, 1050.0000000, -8560.5742190, nullptr, nullptr}, //SPR Big Key Chest
/* 188 */{0x06, 7, stage::allStages[51], 2, 0x11, 0xFF, 0b110000000100000000010, -6233.2583010, -1800.0000000, -9865.0205080, nullptr, nullptr}, //Snowpeak Frozen Lanturn Chest
/* 189 */{0x06, 7, stage::allStages[38], 3, 0x11, 0xFF, 0b100000000100000000010, -810.7105710, -300.0000000, -2101.0502930, nullptr, nullptr}, //Grotto - Freezard Chest
/* 190 */{0x21, 3, stage::allStages[30], 0, 0x11, 0xFF, 0b000000000100000000000, 0.0000000, 0.0000000, -7900.0000000, nullptr, nullptr}, //Frozen Block Cave Chest
/* 191 */{0x0D, 5, stage::allStages[54], 3, 0x11, 0xFF, 0b110100000000000000000, -15394.4238280, 2300.0000000, 2483.9230960, nullptr, nullptr}, //Lost Woods Lanturn Chest
/* 192 */{0x06, 7, stage::allStages[54], 3, 0x11, 0xFF, 0b000000000000100000000, -6840.3515620, 2000.0000000, 6329.0605470, nullptr, nullptr}, //Lost Woods Spinner Chest
/* 193 */{0x20, 8, stage::allStages[9], 0, 0x11, 0xFF, 0b110001000000000000000, 2500.0000000, 56.2500000, 368.7500000, nullptr, nullptr}, //ToT Lobby Lanturn Chest
/* 194 */{0x10, 5, stage::allStages[9], 1, 0x11, 0xFF, 0b000001000000000000000, -12.5000000, 1100.0000000, 8362.5000000, nullptr, nullptr}, //ToT First Stair Pot Small Chest
/* 195 */{0x04, 7, stage::allStages[9], 1, 0x11, 0xFF, 0b000001000000000000000, 5795.0000000, 2505.0000000, 4210.0000000, nullptr, nullptr}, //ToT First Stair Window Small Chest
/* 196 */{0x23, 2, stage::allStages[9], 1, 0x11, 0x11, 0b000001000000000000000, 6925.0000000, 2325.0000000, 3400.0000000, nullptr, nullptr}, //ToT Map Chest
/* 197 */{0x20, 8, stage::allStages[9], 3, 0x11, 0xFF, 0b100001000000100000000, -1737.5000000, 4500.0000000, 5812.5000000, nullptr, nullptr}, //ToT Armos Room Left Chest
/* 198 */{0x24, 2, stage::allStages[9], 4, 0x11, 0x11, 0b100001000000100000000, -3450.0000000, 4450.0000000, -5510.0000000, nullptr, nullptr}, //ToT Compass Chest
/* 199 */{0x05, 7, stage::allStages[9], 5, 0x11, 0xFF, 0b100001000000100000000, -30.0000000, 5750.0000000, -1515.0000000, nullptr, nullptr}, //ToT Scale Room Spider Chest
/* 200 */{0x20, 8, stage::allStages[9], 7, 0x11, 0xFF, 0b100001000000100000000, 5319.0000000, 7550.0000000, 8592.7500000, nullptr, nullptr}, //ToT Third Stair Swinging Gilloutine Chest
/* 201 */{0x05, 7, stage::allStages[9], 7, 0x11, 0xFF, 0b100001000000100000000, 5300.0000000, 8100.0000000, -800.0000000, nullptr, nullptr}, //ToT Third Stair Window Chest
/* 202 */{0x46, 0, stage::allStages[11], 51, 0x11, 0x11, 0b100001000000100100000, 0.0000000, -350.0000000, -2400.0000000, nullptr, nullptr}, //ToT Dominion Rod Chest
/* 203 */{0x04, 7, stage::allStages[9], 5, 0x11, 0xFF, 0b100001000010100000000, 1195.0000000, 7400.0000000, 2350.0000000, nullptr, nullptr}, //ToT Scale Room Upper Chest
/* 204 */{0x04, 7, stage::allStages[9], 6, 0x11, 0xFF, 0b100001000010100000000, 6135.0000000, 8000.0000000, 0.0000000, nullptr, nullptr}, //ToT Helmasaur Room Small Chest
/* 205 */{0x26, 2, stage::allStages[9], 6, 0x11, 0x11, 0b100001000010100000000, 5350.0000000, 7400.0000000, 0.0000000, nullptr, nullptr}, //ToT Big Key Chest
/* 206 */{0x21, 3, stage::allStages[9], 4, 0x12, 0xFF, 0b100001000000110000000, -8740.0000000, 5100.0000000, -4515.0000000, nullptr, nullptr}, //ToT Second Stair Heart Piece Chest
/* 207 */{0x04, 7, stage::allStages[9], 3, 0x11, 0xFF, 0b100001000000100000000, 0.0000000, 4850.0000000, 9200.0000000, nullptr, nullptr}, //ToT Armos Room South Chest
/* 208 */{0x21, 3, stage::allStages[9], 3, 0x12, 0xFF, 0b100001000000110000000, 1740.0000000, 4500.0000000, 5815.0000000, nullptr, nullptr}, //ToT Armos Room Heart Piece Chest
/* 209 */{0x21, 3, stage::allStages[54], 2, 0x12, 0xFF, 0b100001000000010000000, 606.7956540, 1005.0000000, 8005.3901370, nullptr, nullptr}, //Past - Heart Piece Chest
/* 210 */{0x04, 7, stage::allStages[53], 4, 0x12, 0xFF, 0b000000000000000000000, 6500.0000000, 426.0000000, -977.0000000, nullptr, nullptr}, //East Clinic Balcony
/* 211 */{0x21, 3, stage::allStages[56], 0, 0x12, 0xFF, 0b000000000000010000000, 31257.5957030, 900.0000000, -16115.4990230, nullptr, nullptr}, //Eldin Bridge Heart Piece Chest
/* 212 */{0x06, 7, stage::allStages[56], 3, 0x12, 0xFF, 0b000000000000010000000, -10245.4765620, -4400.0000000, 42817.0467500, nullptr, nullptr}, //Kakariko Gorge Owl Chest
/* 213 */{0x06, 7, stage::allStages[57], 8, 0x12, 0xFF, 0b000000000000010000000, -79819.4140620, -1301.2399900, 22400.6718750, nullptr, nullptr}, //Castle Ruins Owl Statue Chest
/* 214 */{0x06, 7, stage::allStages[56], 13, 0x12, 0xFF, 0b100000000010010000000, -93284.5703120, -5000.0000000, 18235.7246090, nullptr, nullptr}, //Hylia Bridge Owl Statue Chest
/* 215 */{0x21, 3, stage::allStages[45], 5, 0x12, 0xFF, 0b100000100000010000000, -21012.1542970, 1350.0000000, -20630.3222660, nullptr, nullptr}, //Faron Woods Owl Statue Heart Piece Chest
/* 216 */{0x06, 7, stage::allStages[59], 0, 0x12, 0xFF, 0b000000000000010000000, 16263.9707030, 989.6500240, 60708.4648440, nullptr, nullptr}, //Desert Owl Statue Chest
/* 217 */{0x18, 5, stage::allStages[12], 0, 0x13, 0xFF, 0b101000000010000000000, -1170.0834960, -755.0000000, 6670.0000000, nullptr, nullptr}, //CiTS Underwater Southwest Chest
/* 218 */{0x04, 7, stage::allStages[12], 0, 0x13, 0xFF, 0b101000000010000000000, 1170.0000000, -755.0000000, 6670.0000000, nullptr, nullptr}, //CiTS Underwater Southeast Chest
/* 219 */{0x20, 8, stage::allStages[12], 10, 0x13, 0xFF, 0b100000000010100000000, -14514.4443360, 0.0000000, -12000.8310550, nullptr, nullptr}, //CiTS West First Chest
/* 220 */{0x23, 2, stage::allStages[12], 5, 0x13, 0x13, 0b101000000010100000000, 17665.1347660, 0.0000000, -11924.1035160, nullptr, nullptr}, //CiTS Map Chest
/* 221 */{0x03, 7, stage::allStages[12], 7, 0x13, 0xFF, 0b101000000010100000000, 15824.6093750, -110.0000000, -9750.6855470, nullptr, nullptr}, //CiTS East Tile Worm Room Chest
/* 222 */{0x04, 7, stage::allStages[12], 7, 0x13, 0xFF, 0b101000000010100000000, 17550.0000000, 1500.0000000, -7200.0000000, nullptr, nullptr}, //CiTS East After-Dinalfos Small Chest
/* 223 */{0x05, 7, stage::allStages[12], 7, 0x13, 0xFF, 0b101000000010100000000, 13470.0000000, 1500.0000000, -7925.0000000, nullptr, nullptr}, //CiTS East After-Dinalfos Chest
/* 224 */{0x47, 0, stage::allStages[14], 51, 0x13, 0x13, 0b101000000010100000000, -0.3629600, 600.0000000, 2279.7690430, nullptr, nullptr}, //CiTS Double Clawshot Chest
/* 225 */{0x24, 2, stage::allStages[12], 4, 0x14, 0x14, 0b101000000001100000000, 10800.0000000, -1775.0000000, -11850.0000000, nullptr, nullptr}, //CiTS Compass Chest
/* 226 */{0x0F, 5, stage::allStages[12], 10, 0x14, 0xFF, 0b100000000001100000000, -11099.1240230, -1500.0000000, -15658.8515620, nullptr, nullptr}, //CiTS West Baba Serpent Alcove Small Chest
/* 227 */{0x04, 7, stage::allStages[12], 10, 0x14, 0xFF, 0b100000000001100000000, -13458.7949220, 0.0000000, -13410.5566410, nullptr, nullptr}, //CiTS West Narrow Ledge Chest
/* 228 */{0x0B, 5, stage::allStages[12], 10, 0x14, 0xFF, 0b100000000001100000000, -10742.9599610, 0.0000000, -15156.7197270, nullptr, nullptr}, //CiTS West Tile Worm Small Chest
/* 229 */{0x03, 7, stage::allStages[12], 11, 0x14, 0xFF, 0b100000000001100000000, -15654.8398440, 2840.2299800, -18906.7890620, nullptr, nullptr}, //CiTS Big Baba Tower West Small Chest
/* 230 */{0x0F, 5, stage::allStages[12], 11, 0x14, 0xFF, 0b100000000001100000000, -12630.1699220, 2430.8999020, -19611.4316410, nullptr, nullptr}, //CiTS Big Baba Tower North Small Chest
/* 231 */{0x21, 3, stage::allStages[12], 11, 0x14, 0xFF, 0b100000000001100000000, -14567.1093750, 2281.0000000, -16989.0351560, nullptr, nullptr}, //CiTS Big Baba Tower Heart Piece Chest
/* 232 */{0x04, 7, stage::allStages[12], 12, 0x14, 0xFF, 0b100000000001100000000, -15782.7958980, 2980.0000000, -11466.6982420, nullptr, nullptr}, //CiTS West Gardens Small Chest
/* 233 */{0x05, 7, stage::allStages[12], 12, 0x14, 0xFF, 0b100000000001100000000, -14270.5380860, 1982.1999510, -7411.9101560, nullptr, nullptr}, //CiTS West Gardens Poe Island Chest
/* 234 */{0x0A, 5, stage::allStages[12], 12, 0x14, 0xFF, 0b100000000001100000000, -12592.9677730, 2400.0000000, -13712.7675780, nullptr, nullptr}, //CiTS West Gardens Lower Small Chest
/* 235 */{0x21, 3, stage::allStages[12], 12, 0x14, 0xFF, 0b100000000001100000000, -11494.3183590, 3000.0000000, -9888.6738280, nullptr, nullptr}, //CiTS West Gardens Heart Piece Chest
/* 236 */{0x04, 7, stage::allStages[12], 13, 0x14, 0xFF, 0b100000000001100000000, 75.2376170, 4500.0000000, -10853.4550780, nullptr, nullptr}, //CiTS Central Outside Small Chest
/* 237 */{0x05, 7, stage::allStages[12], 13, 0x14, 0xFF, 0b100000000001100000000, 4010.3149410, 4500.0000000, -12451.9033200, nullptr, nullptr}, //CiTS Central Outside Poe Chest
/* 238 */{0x26, 2, stage::allStages[12], 2, 0x13, 0x13, 0b100000000001100000000, -1090.9830320, 4500.0000000, -12411.7617190, nullptr, nullptr}, //CiTS Big Key Chest
/* 239 */{0x04, 7, stage::allStages[12], 2, 0x14, 0xFF, 0b100000000001100000000, 11.8030090, 3000.0000000, -13501.7851560, nullptr, nullptr}, //CiTS Central Upper Small Chest
/* 240 */{0x05, 7, stage::allStages[12], 14, 0x14, 0xFF, 0b100000000001100000000, 0.0000000, 894.4799800, -23853.0000000, nullptr, nullptr}, //CiTS North Fan Chest
/* 241 */{0x21, 3, stage::allStages[56], 3, 0x14, 0xFF, 0b000000000001000000000, -22100.0000000, -7176.0297850, 52140.0000000, nullptr, nullptr}, //Kakariko Gorge Heart Piece Chest
/* 242 */{0x06, 7, stage::allStages[52], 1, 0x14, 0xFF, 0b000000000001000000000, -2816.4138180, 1305.0787350, -1395.7875980, nullptr, nullptr}, //Lanayru Spring West DCS Chest
/* 243 */{0x06, 7, stage::allStages[52], 1, 0x14, 0xFF, 0b000000000001000000000, 2798.9057620, 1322.1817720, -987.1356810, nullptr, nullptr}, //Lanayru Spring East DCS Chest
/* 244 */{0x06, 7, stage::allStages[57], 16, 0x14, 0xFF, 0b000000000001000000000, -57374.0820310, -9100.0000000, 29237.9062500, nullptr, nullptr}, //Lake Chasm Chest
/* 245 */{0x20, 8, stage::allStages[15], 1, 0x14, 0xFF, 0b000000000000000000000, -3950.0000000, -1071.0000000, 1375.0000000, nullptr, nullptr}, //PoT West First Room Central Chest
/* 246 */{0x20, 8, stage::allStages[15], 2, 0x14, 0xFF, 0b000000000010000100000, -3950.0000000, -1200.0000000, -5075.0000000, nullptr, nullptr}, //PoT West Second Room Central Chest
/* 247 */{0x24, 2, stage::allStages[15], 2, 0x14, 0x14, 0b000000000010000100000, -2700.0000000, -1196.0000000, -1661.0000000, nullptr, nullptr}, //PoT Compass Chest
/* 248 */{0x06, 7, stage::allStages[15], 2, 0x14, 0xFF, 0b000000000001000100000, -2400.0000000, -21.2500000, -1550.0000000, nullptr, nullptr}, //PoT West Second Room Southeast Chest
/* 249 */{0x21, 3, stage::allStages[15], 1, 0x14, 0xFF, 0b000000000010000000000, -6850.0000000, -771.2500000, 3200.0000000, nullptr, nullptr}, //PoT West First Room Heart Piece Chest
/* 250 */{0x05, 7, stage::allStages[15], 4, 0x14, 0xFF, 0b000000000010000000000, 3250.0000000, -696.2500000, 1235.0000000, nullptr, nullptr}, //PoT East First Room Small Chest
/* 251 */{0x20, 8, stage::allStages[15], 4, 0x14, 0xFF, 0b000000000010000000000, 4650.0000000, -696.2500000, 1235.0000000, nullptr, nullptr}, //PoT East First Room North Chest
/* 252 */{0x05, 7, stage::allStages[15], 5, 0x14, 0xFF, 0b000000000001000100000, 5700.0000000, 3.7500000, -4350.0000000, nullptr, nullptr}, //PoT East Second Room Northeast Small Chest
/* 253 */{0x05, 7, stage::allStages[15], 5, 0x14, 0xFF, 0b000000000001000100000, 2200.0000000, 3.7500000, -5100.0000000, nullptr, nullptr}, //PoT East Second Room Northwest Chest
/* 254 */{0x23, 2, stage::allStages[15], 5, 0x14, 0x14, 0b000000000001000100000, 2300.0000000, -396.2500000, -3300.0000000, nullptr, nullptr}, //PoT Dungeon Map Chest
/* 255 */{0x20, 8, stage::allStages[15], 5, 0x14, 0xFF, 0b000000000001000100000, 5600.0000000, -296.2500000, -3300.0000000, nullptr, nullptr}, //PoT East Second Room Southeast Chest
/* 256 */{0x21, 3, stage::allStages[15], 4, 0x14, 0xFF, 0b000000000001000000000, 5352.5000000, -171.2500000, 3500.0000000, nullptr, nullptr}, //PoT East First Room Heart Piece Chest
/* 257 */{0x05, 7, stage::allStages[15], 4, 0x14, 0xFF, 0b000000000001000000000, 2547.5000000, -171.2500000, 3500.0000000, nullptr, nullptr}, //PoT East First Room West Chest
...
/* 290 */{0x42, 0, stage::allStages[29], 51, 0x10, 0x10, 0b000000100100000000000, -0.0000460, 47.0000000, -473.7650150, nullptr, nullptr}, //SPR Ball and Chain
...
/* 300 */{0x56, 1, stage::allStages[74], 7, 0x14, 0x14, 0b111111100001000000000, -4400.0000000, 0.0000000, 2500.0000000, nullptr, nullptr}, //Giant Quiver
/* 301 */{0x2C, 12, stage::allStages[73], 4, 0xFF, 0xFF, 0b111111100000000000000, -494.7930300, 100.0000000, 3701.0000000, nullptr, nullptr}, //Hylian Shield (Goron)
...
/* 309 */{0x22, 3, stage::allStages[25], 50, 0x9, 0xFF, 0b111111010010101000000, 85.0000000, 1799.0000000, -1264.0000000, nullptr, nullptr}, //Stallord Heart Container
/* 310 */{0x22, 3, stage::allStages[28], 50, 0x11, 0xFF, 0b111111010110101000000, 279.0000000, 43.0000000, -865.0000000, nullptr, nullptr}, //Blizzeta Heart Container
/* 311 */{0x22, 3, stage::allStages[10], 50, 0x12, 0xFF, 0b111111010110111000000, 900.0000000, 0.0000000, 0.0000000, nullptr, nullptr}, //Armogohma Heart Container
/* 312 */{0x22, 3, stage::allStages[13], 50, 0x14, 0xFF, 0b111111010101111000000, 317.0000000, 0.0000000, 764.0000000, nullptr, nullptr}, //Argorok Heart Container
...
/* 315 */{0x30, 12, stage::allStages[73], 0, 0x7, 0xFF, 0b111111100000000000010, 1557.0000000, -200.0000000, 3491.0000000, nullptr, nullptr}, //Magic Armor
...
/* 324 */{0x80, 4, stage::allStages[46], 0, 0x12, 0x12, 0b000000000000000000000, -344.0000000, 0.0000000, 234.0000000, nullptr, nullptr}, //Renado's Letter
/* 325 */{0x81, 4, stage::allStages[53], 5, 0x12, 0x12, 0b000000000000000000000, 3505.0000000, -1150.0000000, 3388.0000000, nullptr, nullptr}, //Invoice
/* 326 */{0x82, 4, stage::allStages[57], 16, 0x12, 0x12, 0b000000000000000000000, -51480.0000000, -6425.0000000, 34034.0000000, nullptr, nullptr},//Wooden Statue
/* 327 */{0x83, 4, stage::allStages[63], 0, 0x12, 0x12, 0b000000000000000000000, 2360.0000000, 104.0000000, -1150.0000000, nullptr, nullptr},//Ilia's Charm
/* 328 */{0x84, 4, stage::allStages[68], 0, 0x12, 0x12, 0b000000000000000000000, -386.0000000, 0.0000000, 393.0000000, nullptr, nullptr}, //Horse Call
...
/* 335 */{0x21, 3, stage::allStages[62], 0, 0x7, 0xFF, 0b101000000010000000000, -2678.128906, -167.094162, 2246.794186, nullptr, nullptr}, //Fishing Heart Piece
/* 336 */{0x21, 3, stage::allStages[56], 0, 0x7, 0xFF, 0b000000000000000000000, -25148.583984, -200.000000, 9814.881836, nullptr, nullptr}, //Goron Springwater Heart Piece
/* 337 */{0x21, 3, stage::allStages[61], 0, 0x7, 0xFF, 0b000000000000000000000, 3618.216797, 232.476608, 541.905518, nullptr, nullptr}, //Flying Minigame Heart Piece
/* 338 */{0x21, 3, stage::allStages[55], 1, 0x7, 0xFF, 0b000000000000000000000, 4708.924805, 260.000000, -3120.967529, nullptr, nullptr}, //Boar Over Fire Heart Piece
/* 339 */{0x23, 2, stage::allStages[27], 1, 0x10, 0x10, 0b000000000000000000000, 293.920288, 0.000000, -337.167480, nullptr, nullptr}, //Snowpeak Ruins Map
/* 340 */{0x21, 3, stage::allStages[51], 1, 0x11, 0xFF, 0b000000000000000000000, -71795.539062, -54450.000000, 56396.738281, nullptr, nullptr}, //Snowboarding Heart Piece
/* 341 */{0x21, 3, stage::allStages[63], 0, 0x12, 0xFF, 0b000000000000000000010, 2200.000000, 104.574730, -1200.000000, nullptr, nullptr}, //Hide and Seek Heart Piece
...
//Ooccoo
{0x33, 2, stage::allStages[6], 1, 0x1, 0x1, 0b000000000000000000100, 3775.943604, 3167.790039, 5428.488281, nullptr, nullptr},
{0x33, 2, stage::allStages[3], 14, 0x3, 0x3, 0b000000000000000000000, -14154.718750, 190.286682, 2185.947510, nullptr, nullptr},
{0x33, 2, stage::allStages[0], 2, 0x6, 0x6, 0b000000000000000000000, 2045.683228, 1500.000000, 1642.919189, nullptr, nullptr},
{0x33, 2, stage::allStages[24], 10, 0x8, 0x8, 0b000000000000000000000, -667.577815, -2100.000000, 4029.893311, nullptr, nullptr},
{0x33, 2, stage::allStages[27], 2, 0x10, 0x10, 0b000000000000000000000, 3742.823975, 0.000000, 1621.097900, nullptr, nullptr},
{0x33, 2, stage::allStages[9], 0, 0x11, 0x11, 0b000000000000000000000, -28.417549, 725.000000, 3091.288574, nullptr, nullptr},
{0x33, 2, stage::allStages[12], 16, 0x13, 0x13, 0b000000000000000000000, 6082.295898, 0.000000, 5896.656738, nullptr, nullptr},
//overworld keys
...
{0xca, 10, stage::allStages[56], 3, 0x2, 0xFF, 0b000000000000000000000, -9730.929688, -7200.000000, 57526.199219, nullptr, nullptr},
{0xcb, 10, stage::allStages[56], 3, 0x2, 0xFF, 0b000000000000000000000, 562.488159, -6092.589844, 61677.734375, nullptr, nullptr},
{0xd4, 10, stage::allStages[48], 0, 0x2, 0xFF, 0b000000000000000000000, 17085.654297, 557.072510, -850.370605, nullptr, nullptr},
{0xd5, 10, stage::allStages[68], 6, 0x2, 0xFF, 0b000000000000000000000, 205.938171, 17.797655, 4.593423, nullptr, nullptr},
{0xc6, 10, stage::allStages[56], 0, 0x2, 0xFF, 0b000000000000000000000, 19503.787109, 662.713684, 13563.345703, nullptr, nullptr},
{0xc7, 10, stage::allStages[56], 0, 0x2, 0xFF, 0b000000000000000000000, -10765.343750, 80.466759, -9151.101562, nullptr, nullptr},
{0xc8, 10, stage::allStages[56], 0, 0x2, 0xFF, 0b000100000010000000000, 34607.441406, -260.000000, -14273.162109, nullptr, nullptr},
{0xc9, 10, stage::allStages[56], 0, 0x2, 0xFF, 0b000100000010000000000, 37897.406250, -260.000000, -40525.894531, nullptr, nullptr},
{0xcc, 10, stage::allStages[56], 13, 0x5, 0xFF, 0b000100000010000000000, -93754.703125, -5925.377441, 31642.708984, nullptr, nullptr},
{0xcd, 10, stage::allStages[56], 13, 0x5, 0xFF, 0b000100000010000000000, -88147.609375, -6854.451660, 58998.777344, nullptr, nullptr},
{0xc2, 10, stage::allStages[57], 8, 0x5, 0xFF, 0b000000000000000000000, -75074.406250, -384.115967, 16053.256836, nullptr, nullptr},
{0xc3, 10, stage::allStages[57], 8, 0x5, 0xFF, 0b000100000010000000000, -78787.265625, -1472.352661, 2016.588013, nullptr, nullptr},
{0xce, 10, stage::allStages[57], 16, 0x5, 0xFF, 0b000000000000000000000, -45085.273438, 6042.771484, 29910.453125, nullptr, nullptr},
{0xcf, 10, stage::allStages[57], 16, 0x5, 0xFF, 0b000000000000000000000, -54377.070312, -5460.576660, 27647.970703, nullptr, nullptr},
...
{0xd1, 10, stage::allStages[54], 2, 0x11, 0xFF, 0b000100000010000000000, 521.038208, 1000.000000, 5867.415527, nullptr, nullptr},
//bug rewards
{0x35, 1, stage::allStages[73], 3, 0xFF, 0x5, 0b000000000000000000000, -123.609940, 40.000000, 305.168640, nullptr, nullptr},
{0x06, 7, stage::allStages[73], 3, 0xFF, 0xFF, 0b000000000000000000000, -123.609940, 40.000000, 305.168640, nullptr, nullptr},
{0x05, 7, stage::allStages[73], 3, 0xFF, 0xFF, 0b000000000000000000000, -123.609940, 40.000000, 305.168640, nullptr, nullptr},
{0x06, 7, stage::allStages[73], 3, 0xFF, 0xFF, 0b000000000000000000000, -123.609940, 40.000000, 305.168640, nullptr, nullptr},
{0x05, 7, stage::allStages[73], 3, 0xFF, 0xFF, 0b000000000000000000000, -123.609940, 40.000000, 305.168640, nullptr, nullptr},
{0x06, 7, stage::allStages[73], 3, 0xFF, 0xFF, 0b000000000000000000000, -123.609940, 40.000000, 305.168640, nullptr, nullptr},
{0x05, 7, stage::allStages[73], 3, 0xFF, 0xFF, 0b000000000000000000000, -123.609940, 40.000000, 305.168640, nullptr, nullptr},
...
{0x06, 7, stage::allStages[73], 3, 0xFF, 0xFF, 0b000000000000000000000, -123.609940, 40.000000, 305.168640, nullptr, nullptr},
{0x05, 7, stage::allStages[73], 3, 0xFF, 0xFF, 0b000000000000000000000, -123.609940, 40.000000, 305.168640, nullptr, nullptr},
{0x36, 1, stage::allStages[73], 3, 0xFF, 0x11, 0b000000000000000000000, -123.609940, 40.000000, 305.168640, nullptr, nullptr},
//poes
/*#1*/{0xe0, 11, stage::allStages[24], 2, 0x7, 0xFF, 0b000000000000000000010, 105.801384, -19.549999, -741.391968, nullptr, nullptr},
/*#2*/{0xe0, 11, stage::allStages[24], 3, 0x7, 0xFF, 0b100000000010000000010, 3606.844482, 150.030182, -5323.249512, nullptr, nullptr},
/*#3*/{0xe0, 11, stage::allStages[24], 5, 0x7, 0xFF, 0b000000000000000000010, 5712.277344, 1050.019775, 4526.544922, nullptr, nullptr},
/*#4*/{0xe0, 11, stage::allStages[24], 8, 0x7, 0xFF, 0b000000000000000000010, -4197.771973, 1040.154663, 4983.674805, nullptr, nullptr},
/*#5*/{0xe0, 11, stage::allStages[73], 5, 0x7, 0xFF, 0b000000000000000000010, 4186.364746, -75.000000, 2795.808350, nullptr, nullptr},
/*#6*/{0xe0, 11, stage::allStages[31], 16, 0x9, 0xFF, 0b100000000000100000010, 126.849854, -20000.000000, -337.206903, nullptr, nullptr},
/*#7*/{0xe0, 11, stage::allStages[31], 32, 0x12, 0xFF, 0b100000000100110000010, 231.875824, -40000.000000, -216.2944296, nullptr, nullptr},
/*#8*/{0xe0, 11, stage::allStages[31], 43, 0x14, 0xFF, 0b100000000101110000010, -4560.734375, -53750.000000, -825.646851, nullptr, nullptr},
/*#9*/{0xe0, 11, stage::allStages[12], 12, 0x14, 0xFF, 0b100000000001000000010, -12660.987305, 1982.199951, -7632.476074, nullptr, nullptr},
/*#10*/{0xe0, 11, stage::allStages[12], 13, 0x14, 0xFF, 0b100000000001000000010, 3916.892090, 4496.779785, -12149.609375, nullptr, nullptr},
/*#11*/{0xe0, 11, stage::allStages[47], 0, 0x7, 0xFF, 0b000000000000000000010, -2502.529785, -1533.660522, 18041.601562, nullptr, nullptr},
/*#12*/{0xe0, 11, stage::allStages[45], 11, 0x7, 0xFF, 0b000000000000000000010, -25786.427734, 300.000000, -20456.810547, nullptr, nullptr},
/*#13*/{0xe0, 11, stage::allStages[59], 0, 0x7, 0xFF, 0b000000000000000000010, 66240.039062, 143.258804, 56904.339844, nullptr, nullptr},
/*#14*/{0xe0, 11, stage::allStages[59], 0, 0x7, 0xFF, 0b100000000010000000010, -816.907959, 2496.226562, 57933.289062, nullptr, nullptr},
/*#15*/{0xe0, 11, stage::allStages[59], 0, 0x7, 0xFF, 0b100000000010000000010, 26747.324219, -46.507732, 26175.406250, nullptr, nullptr},
/*#16*/{0xe0, 11, stage::allStages[37], 2, 0x7, 0xFF, 0b100000000010000000010, -1026.819824, 1.152117, -161.420013, nullptr, nullptr},
/*#17*/{0xe0, 11, stage::allStages[37], 2, 0x7, 0xFF, 0b100000000010000000010, -286.849121, 3.514773, -895.548218, nullptr, nullptr},
/*#18*/{0xe0, 11, stage::allStages[59], 0, 0x7, 0xFF, 0b100000000010000000010, -2024.554443, 16.013172, 11583.281250, nullptr, nullptr},
/*#19*/{0xe0, 11, stage::allStages[55], 3, 0x7, 0xFF, 0b000000000000000000010, 1812.931274, 0.000000, 1155.415161, nullptr, nullptr},
/*#20*/{0xe0, 11, stage::allStages[55], 3, 0x7, 0xFF, 0b000000000000000000010, 283.265228, 840.000000, -12366.407227, nullptr, nullptr},
/*#21*/{0xe0, 11, stage::allStages[48], 0, 0x7, 0xFF, 0b000000000000000000010, 12836.060547, 100.000000, 178.608246, nullptr, nullptr},
/*#22*/{0xe0, 11, stage::allStages[48], 0, 0x7, 0xFF, 0b000000000000000000010, 14444.615234, 256.835815, -527.642578, nullptr, nullptr},
/*#24*/{0xe0, 11, stage::allStages[63], 0, 0x12, 0xFF, 0b100000000000010000010, 1683.054077, 480.000000, -6715.406250, nullptr, nullptr},
/*#24*/{0xe0, 11, stage::allStages[57], 8, 0x7, 0xFF, 0b000000000000000000010, -81042.460938, -1650.079956, 21720.513672, nullptr, nullptr},
/*#25*/{0xe0, 11, stage::allStages[57], 17, 0x7, 0xFF, 0b000000000000000000010, -42291.773438, -1400.000000, 10844.620117, nullptr, nullptr},
/*#26*/{0xe0, 11, stage::allStages[56], 3, 0x7, 0xFF, 0b000000000000000000010, -10858.849609, -5700.000000, 55509.773438, nullptr, nullptr},
/*#27*/{0xe0, 11, stage::allStages[32], 0, 0x7, 0xFF, 0b110000000000000000010, 4567.875977, 5027.688477, -5207.911621, nullptr, nullptr},
/*#28*/{0xe0, 11, stage::allStages[56], 6, 0x7, 0xFF, 0b000000000000000000010, -45153.691406, -8909.261719, 74205.156250, nullptr, nullptr},
/*#29*/{0xe0, 11, stage::allStages[56], 10, 0x7, 0xFF, 0b110000000000000000010, -45192.148438, -2474.139893, -32984.613281, nullptr, nullptr},
/*#30*/{0xe0, 11, stage::allStages[35], 0, 0x7, 0xFF, 0b110000000000000000010, 269.485474, 22.380699, -981.643372, nullptr, nullptr},
/*#31*/{0xe0, 11, stage::allStages[35], 0, 0x7, 0xFF, 0b110000000000000000010, -236.254684, 150.000000, -1036.175781, nullptr, nullptr},
/*#32*/{0xe0, 11, stage::allStages[57], 16, 0x7, 0xFF, 0b000000000000000000010, -53146.578125, -5153.850098, 25666.673828, nullptr, nullptr},
/*#33*/{0xe0, 11, stage::allStages[56], 13, 0x7, 0xFF, 0b100000001010000000010, -81177.609375, -6000.000000, 65960.148438, nullptr, nullptr},
/*#34*/{0xe0, 11, stage::allStages[46], 0, 0x7, 0xFF, 0b000000000000000000010, 3372.341553, 2300.000000, -3018.808594, nullptr, nullptr},
/*#35*/{0xe0, 11, stage::allStages[46], 0, 0x7, 0xFF, 0b000000000000000000010, -1487.586548, 3848.365234, -5915.137207, nullptr, nullptr},
/*#36*/{0xe0, 11, stage::allStages[52], 0, 0x7, 0xFF, 0b000000000000000000010, -74531.953125, -18336.878906, 47025.640625, nullptr, nullptr},
/*#37*/{0xe0, 11, stage::allStages[52], 0, 0x7, 0xFF, 0b000000000000000000010, -96335.820312, -17510.320312, 62149.574219, nullptr, nullptr},
/*#38*/{0xe0, 11, stage::allStages[52], 0, 0x7, 0xFF, 0b000000000000000000010, -115949.156250, -15840.000000, 59894.671875, nullptr, nullptr},
/*#39*/{0xe0, 11, stage::allStages[52], 0, 0x7, 0xFF, 0b101000000000000000010, -104251.976562, -18469.791016, 42262.726562, nullptr, nullptr},
/*#40*/{0xe0, 11, stage::allStages[52], 0, 0x7, 0xFF, 0b101000000000000000010, -115114.968750, -14096.000000, 25330.574219, nullptr, nullptr},
/*#41*/{0xe0, 11, stage::allStages[33], 0, 0x7, 0xFF, 0b100000100000000000010, 8918.118164, 355.380005, -6922.565430, nullptr, nullptr},
/*#42*/{0xe0, 11, stage::allStages[33], 0, 0x7, 0xFF, 0b110000000000000000010, 801.443970, -4197.580078, -20497.589844, nullptr, nullptr},
/*#43*/{0xe0, 11, stage::allStages[33], 0, 0x7, 0xFF, 0b110000000000000000010, 6740.693848, -5139.174805, -10953.290039, nullptr, nullptr},
/*#44*/{0xe0, 11, stage::allStages[54], 3, 0x11, 0xFF, 0b100000100000000000010, -5483.465332, 500.000000, 5302.014648, nullptr, nullptr},
/*#45*/{0xe0, 11, stage::allStages[54], 1, 0x11, 0xFF, 0b000000000000000000010, 1214.411987, 1639.093384, -3631.436035, nullptr, nullptr},
/*#46*/{0xe0, 11, stage::allStages[54], 3, 0x11, 0xFF, 0b000000000000000000010, -21789.335936, 2200.000000, 10000.409180, nullptr, nullptr},
/*#47*/{0xe0, 11, stage::allStages[51], 0, 0x10, 0xFF, 0b100000000000000010010, 843.887695, -9361.725586, -21468.560547, nullptr, nullptr},
/*#48*/{0xe0, 11, stage::allStages[51], 0, 0x10, 0xFF, 0b100000000000000010010, 7834.021484, -8356.457031, -18110.230469, nullptr, nullptr},
/*#49*/{0xe0, 11, stage::allStages[51], 0, 0x10, 0xFF, 0b100000000000000010010, -4954.811035, -4714.479980, -18838.253906, nullptr, nullptr},
/*#50*/{0xe0, 11, stage::allStages[51], 2, 0x11, 0xFF, 0b100000000100000000010, -6137.537598, -1800.000000, -10043.368164, nullptr, nullptr},
/*#51*/{0xe0, 11, stage::allStages[51], 1, 0x10, 0xFF, 0b100000000000000010010, -69507.492188, -52429.000000, 62508.425781, nullptr, nullptr},
/*#52*/{0xe0, 11, stage::allStages[27], 0, 0x10, 0xFF, 0b000000000000000000010, -238.949356, -2.310000, 2920.424072, nullptr, nullptr},
/*#53*/{0xe0, 11, stage::allStages[27], 0, 0x11, 0xFF, 0b100000000100000000010, 533.658569, -84.440002, 5910.784180, nullptr, nullptr},
/*#54*/{0xe0, 11, stage::allStages[27], 6, 0x11, 0xFF, 0b100000000100000000010, 4784.004395, 950.000000, 331.876648, nullptr, nullptr},
/*#55*/{0xe0, 11, stage::allStages[9], 2, 0x12, 0xFF, 0b100000000000010000010, -3295.982178, 2750.000000, 11.354874, nullptr, nullptr},
/*#56*/{0xe0, 11, stage::allStages[9], 5, 0x11, 0xFF, 0b100000000010100000010, 1861.281128, 7400.000000, -358.31518, nullptr, nullptr},
/*#57*/{0xe0, 11, stage::allStages[54], 2, 0x12, 0xFF, 0b100000000000010000010, -1086.470947, 925.000000, 6306.895020, nullptr, nullptr},
/*#58*/{0xe0, 11, stage::allStages[61], 0, 0x7, 0xFF, 0b000000000000000000010, 942.983948, 817.438049, 3387.270996, nullptr, nullptr},
/*#59*/{0xe0, 11, stage::allStages[50], 0, 0x7, 0xFF, 0b000000000000000000010, 3444.790039, -4658.747559, 11720.103516, nullptr, nullptr},
